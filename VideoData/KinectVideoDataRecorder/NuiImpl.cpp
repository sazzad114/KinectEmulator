...
FileWriter videoFile("video.dat");
...
const NUI_IMAGE_FRAME * keyFrame = NULL;
int frameCount = 0;
int framesBetweenKeyFrames = 100;
...
void CSkeletalViewerApp::Nui_GotVideoAlert( )
{
	...
	//	if(frameCount % framesBetweenKeyFrames == 0) {
			keyFrame = pImageFrame;
			videoFile.WriteVideoData(pImageFrame,keyFrame,true);
	/*	}
		else
		{
			videoFile.WriteVideoData(pImageFrame,keyFrame,false);
		}*/
